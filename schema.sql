...
INSERT INTO posts (post_title, post_link, post_text, post_rating, com_id, user_name, track_id)
...
VALUES('What''s the deal with ''Yer Blues'' by the Beatles?', 'test_link_1', 
        ...
        1, 1, 'doejohn23', '2AsGApoUuN8pTM17Lq9eUd');
INSERT INTO posts (post_title, post_link, post_text, post_rating, com_id, user_name, track_id)
VALUES('What''s the story behind ''Get Back'' by the Beatles?', 
        ...
        1, 2, 'smithjane84', '47qD4mGcc6cS4PbkvoIcy9');
INSERT INTO posts (post_title, post_link, post_text, post_rating, com_id, user_name, track_id)
VALUES('I can''t get enough of ''When the Levee Breaks'' by Led Zeppelin', 
        ...
        1, 3, 'rjohnson96', '05f8Hg3RSfiPSCBQOtxl3i');
INSERT INTO posts (post_title, post_link, post_text, post_rating, com_id, user_name, track_id)
VALUES('Did you know... about ''Sittin'' on the Dock of the Bay'' by Otis Redding?', 
        ...
        1, 4, 'emilyw87', '3zBhihYUHBmGd2bcQIobrF');

INSERT INTO comments (comment_text, user_name, post_id, parent_id, rating)
VALUES('TestTestTestTest', 'smithjane84', 1, 0, 1);
